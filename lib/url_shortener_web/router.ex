defmodule UrlShortenerWeb.Router do
  ...
  scope "/", UrlShortenerWeb do
    ...
    get "/", ShortUrlController, :new
    resources "/short_urls", ShortUrlController
    get "/s/:slug", ShortUrlController, :convert_short_slug
    get "/stats", ShortUrlController, :index
    get "/export", ShortUrlController, :export
  end
